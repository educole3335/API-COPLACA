...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    List<Order> findByWarehouseIdAndStatusInOrderByCreatedAtAsc(Long warehouseId, Collection<OrderStatus> statuses);
    ...
    long countByDeliveryAgentIdAndStatusIn(Long deliveryAgentId, Collection<OrderStatus> statuses);
