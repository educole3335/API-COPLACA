...
| docs/PRESENTACION_BACKEND.md | Presentacion tecnica completa | Liderazgo tecnico, stakeholders, equipo | Sesion extendida con guion slide por slide y tiempos |
...
4. docs/FLUJO_API_PASO_A_PASO.md
5. docs/MAPA_BACKEND.md
6. docs/REFERENCIA_API.md
7. docs/ESTADO_BACKEND.md
8. docs/PRESENTACION_TECNICA_BACKEND.md
9. docs/PRESENTACION_BACKEND.md
