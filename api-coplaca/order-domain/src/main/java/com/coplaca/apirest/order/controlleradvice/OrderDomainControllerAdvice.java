package com.coplaca.apirest.order.controlleradvice;

import com.coplaca.apirest.exception.ResourceNotFoundException;
import com.coplaca.apirest.order.controller.OrderDomainController;
...
@RestControllerAdvice(basePackageClasses = OrderDomainController.class)
public class OrderDomainControllerAdvice {
