package com.coplaca.apirest.user.controlleradvice;

import com.coplaca.apirest.exception.ResourceNotFoundException;
import com.coplaca.apirest.user.controller.UserDomainController;
...
@RestControllerAdvice(basePackageClasses = UserDomainController.class)
public class UserDomainControllerAdvice {
